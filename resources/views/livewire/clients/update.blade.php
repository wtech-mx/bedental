                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-center">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                <a class="nav-link active" id="cliente2-tab" data-toggle="tab" href="#cliente2" role="tab" aria-controls="cliente2" aria-selected="true">Paciente</a>
                                </li>

                                <li class="nav-item">
                                <a class="nav-link" id="facturacion2-tab" data-toggle="tab" href="#facturacion2" role="tab" aria-controls="facturacion2" aria-selected="false">Facturación</a>
                                </li>
                            ...
                            <div class="tab-pane fade show active" id="cliente2" role="tabpanel" aria-labelledby="cliente2-tab">
                                <div class="row mt-3">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <textarea wire:model.defer="motivo_consulta" class="form-control"></textarea>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="fiscals" role="tabpanel" aria-labelledby="fiscals-tab">
                                <div class="row mt-3">
                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 ">
                                        ...
                                        <input wire:model.defer="pdf_fiscal" type="file" class="form-control" id="pdf_fiscal" placeholder="pdf_fiscal">@error('pdf_fiscal') <span class="error text-danger">{{ $message }}</span> @enderror
                                        <iframe width="400" height="400" src="{{asset('pdf_fiscal/' . $row->pdf)}}" frameborder="0"></iframe>
                                    </div>
                                </div>
                            </div>
                            {{-- tab datos de fiscal --}}
