<!-- Modal -->
<div class="modal fade" id="Historial_radiografíco{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<div class="tab-content" id="myTabContent">
  <div class="tab-pane fade show active" id="individual" role="tabpanel" aria-labelledby="individual-tab">
        <h3 class="mt-5 mb-5 text-center">Carga Individual</h3>
         <form action="{{ route('radiografia.upload', [$row->id]) }}" method="post"  enctype="multipart/form-data">
              @csrf
             <div class="row">
  ...
  <div class="tab-pane fade" id="masiva" role="tabpanel" aria-labelledby="masiva-tab">
      <h3 class="mt-5 mb-5 text-center">Carga Masiva</h3>
         <form action="{{ route('radiografia.upload', [$row->id]) }}" method="post" name="file_name" files="true" enctype="multipart/form-data" class="dropzone" id="image-upload">
              @csrf
             <div class="row">
