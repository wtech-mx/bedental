<!-- Modal -->
<div class="modal fade" id="createDataModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('client.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-center">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="fiscals-tab" data-toggle="tab" href="#fiscals" role="tab"
                                        aria-controls="fiscals" aria-selected="false">Pdf Fiscal</a>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12 col-md-6 ">
                                        ...
                                        <input name="sanguineo" type="text" class="form-control" id="sanguineo"
                                            placeholder="sanguineo">@error('sanguineo') <span
                                    ...
                                    <div class="form-group col-xs-12 col-sm-12 col-md-6">
                                        ...
                                        <input name="ocupacion" type="text" class="form-control" id="ocupacion"
                                            placeholder="ocupación">@error('ocupacion') <span
                                            class="error text-danger">{{ $message }}</span> @enderror
                                    </div>
                            ...
                            <div class="tab-pane fade" id="fiscals" role="tabpanel" aria-labelledby="fiscals-tab">
                                <div class="row mt-3">
                                    <div class="form-group col-xs-12 col-sm-12 col-md-12 ">
                                        ...
                                        <input name="pdf_fiscal" type="file" class="form-control"
                                            id="pdf_fiscal">@error('pdf_fiscal') <span class="error text-danger">{{
                                            $message }}</span> @enderror
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary close-modal">Crear</button>
                </div>
            </form>
        </div>
    </div>
