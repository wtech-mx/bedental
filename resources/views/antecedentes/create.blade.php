        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo1" type="text" class="form-control" id="tiempo1" placeholder="Tiempo1">@error('tiempo1') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco1"></label>
                <input wire:model.defer="parentesco1" type="text" class="form-control" id="parentesco1" placeholder="Parentesco1">@error('parentesco1') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo2" type="text" class="form-control" id="tiempo2" placeholder="Tiempo2">@error('tiempo2') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco2"></label>
                <input wire:model.defer="parentesco2" type="text" class="form-control" id="parentesco2" placeholder="Parentesco2">@error('parentesco2') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo3" type="text" class="form-control" id="tiempo3" placeholder="Tiempo3">@error('tiempo3') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco3"></label>
                <input wire:model.defer="parentesco3" type="text" class="form-control" id="parentesco3" placeholder="Parentesco3">@error('parentesco3') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo4" type="text" class="form-control" id="tiempo4" placeholder="Tiempo4">@error('tiempo4') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco4"></label>
                <input wire:model.defer="parentesco4" type="text" class="form-control" id="parentesco4" placeholder="Parentesco4">@error('parentesco4') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo5" type="text" class="form-control" id="tiempo5" placeholder="Tiempo5">@error('tiempo5') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco5"></label>
                <input wire:model.defer="parentesco5" type="text" class="form-control" id="parentesco5" placeholder="Parentesco5">@error('parentesco5') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo6" type="text" class="form-control" id="tiempo6" placeholder="Tiempo6">@error('tiempo6') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco6"></label>
                <input wire:model.defer="parentesco6" type="text" class="form-control" id="parentesco6" placeholder="Parentesco6">@error('parentesco6') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo7" type="text" class="form-control" id="tiempo7" placeholder="Tiempo7">@error('tiempo7') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco7"></label>
                <input wire:model.defer="parentesco7" type="text" class="form-control" id="parentesco7" placeholder="Parentesco7">@error('parentesco7') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo8" type="text" class="form-control" id="tiempo8" placeholder="Tiempo8">@error('tiempo8') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco8"></label>
                <input wire:model.defer="parentesco8" type="text" class="form-control" id="parentesco8" placeholder="Parentesco8">@error('parentesco8') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo9" type="text" class="form-control" id="tiempo9" placeholder="Tiempo9">@error('tiempo9') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco9"></label>
                <input wire:model.defer="parentesco9" type="text" class="form-control" id="parentesco9" placeholder="Parentesco9">@error('parentesco9') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo10" type="text" class="form-control" id="tiempo10" placeholder="Tiempo10">@error('tiempo10') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco10"></label>
                <input wire:model.defer="parentesco10" type="text" class="form-control" id="parentesco10" placeholder="Parentesco10">@error('parentesco10') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo11" type="text" class="form-control" id="tiempo11" placeholder="Tiempo11">@error('tiempo11') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco11"></label>
                <input wire:model.defer="parentesco11" type="text" class="form-control" id="parentesco11" placeholder="Parentesco11">@error('parentesco11') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo12" type="text" class="form-control" id="tiempo12" placeholder="Tiempo12">@error('tiempo12') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco12"></label>
                <input wire:model.defer="parentesco12" type="text" class="form-control" id="parentesco12" placeholder="Parentesco12">@error('parentesco12') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo13" type="text" class="form-control" id="tiempo13" placeholder="Tiempo13">@error('tiempo13') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco13"></label>
                <input wire:model.defer="parentesco13" type="text" class="form-control" id="parentesco13" placeholder="Parentesco13">@error('parentesco13') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo14" type="text" class="form-control" id="tiempo14" placeholder="Tiempo14">@error('tiempo14') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco14"></label>
                <input wire:model.defer="parentesco14" type="text" class="form-control" id="parentesco14" placeholder="Parentesco14">@error('parentesco14') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo15" type="text" class="form-control" id="tiempo15" placeholder="Tiempo15">@error('tiempo15') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco15"></label>
                <input wire:model.defer="parentesco15" type="text" class="form-control" id="parentesco15" placeholder="Parentesco15">@error('parentesco15') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo16" type="text" class="form-control" id="tiempo16" placeholder="Tiempo16">@error('tiempo16') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco16"></label>
                <input wire:model.defer="parentesco16" type="text" class="form-control" id="parentesco16" placeholder="Parentesco16">@error('parentesco16') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo17" type="text" class="form-control" id="tiempo17" placeholder="Tiempo17">@error('tiempo17') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco17"></label>
                <input wire:model.defer="parentesco17" type="text" class="form-control" id="parentesco17" placeholder="Parentesco17">@error('parentesco17') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo18" type="text" class="form-control" id="tiempo18" placeholder="Tiempo18">@error('tiempo18') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco18"></label>
                <input wire:model.defer="parentesco18" type="text" class="form-control" id="parentesco18" placeholder="Parentesco18">@error('parentesco18') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
            ...
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                ...
                <input wire:model.defer="tiempo19" type="text" class="form-control" id="tiempo19" placeholder="Tiempo19">@error('tiempo19') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
            <div class="form-group col-xs-12 col-sm-12 col-md-6">
                <label for="parentesco19"></label>
                <input wire:model.defer="parentesco19" type="text" class="form-control" id="parentesco19" placeholder="Parentesco19">@error('parentesco19') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
